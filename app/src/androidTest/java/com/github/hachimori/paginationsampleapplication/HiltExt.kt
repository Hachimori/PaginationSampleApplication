...
/**
 * launchFragmentInContainer() from androidx.fragment:fragment-testing doesn't work with Hilt,
 * because its activity is not annotated with @AndroidEntryPoint. For a workaround,
 * launchFragmentInHiltContainer() is defined in this file.
 *
